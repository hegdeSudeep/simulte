...
std::vector<double> OmniscientEntity::getSINR(MacNodeId from, MacNodeId to, const SimTime time, const double transmissionPower, const Direction direction) const {
    if (from == to)
